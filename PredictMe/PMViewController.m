...
- (void)viewDidLoad
{
    ...
    self.predictor=[[PMPredictor alloc]init];
...
// Adds the image programmatically
...
//    to change the frame size of label
...
-(void) makePrediction {
    ...
    self.predictionLabel.text=[self.predictor randomPrediction];
